        ...
        home: SingleChildScrollView(
          ...
          Column(
            children: [
              ...
              Row(
                children: [
                  Flexible(child: wigi.MyCard(imagename: 'profile.jpg' , Huduma: 'Profile',function:  void _onTabTapped() {
                  setState(() {
                  _currentIndex = 1;
                  });
                  }
                  ),)
                  Flexible(child: wigi.MyCard(imagename: 'services.jpg', Huduma: 'Service',function: (){
                    Navigator.push(
                        context,
                        MaterialPageRoute(
              ...
              Row(
                children: [
                  Flexible(child: wigi.MyCard(imagename: 'report.jpg', Huduma: 'Report',function: (){
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                        builder: (context) => InsideReports()));
                  })),
                  Flexible(child: wigi.MyCard(imagename: 'stock.jpg', Huduma: 'Stock',function: (){
                    Navigator.push(
                        context,
                        MaterialPageRoute(
              ...
              Row(
                children: [
                  Flexible(child: wigi.MyCard(imagename: 'settings.jpg', Huduma: 'Settings',function: (){
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                        builder: (context) => InsideSettings()));
                  })),
                  Flexible(child: wigi.MyCard(imagename: 'alpha.png', Huduma: 'Log Out',function: (){
                    Navigator.push(
                        context,
                        MaterialPageRoute(
