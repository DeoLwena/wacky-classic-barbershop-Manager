...
class DebitsCredits extends StatelessWidget {
  @override
        ...
        body: Padding(
          ...
          child: Form(
              ...
              child: Column(
                ...
                children: [
                  wigi.mydropdown(listname: _levelone,dropname: "Chagua Aina",),
                  SizedBox(
                    height: screenheight * 0.05,
                  ),
                  wigi.TextInput(lebo: 'Name '),
                  SizedBox(
                    height: screenheight * 0.05,
                  ),
