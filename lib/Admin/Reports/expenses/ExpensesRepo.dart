...
class expenceRepo extends StatelessWidget {
  @override
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          ...
          wigi.stripTile(
            ikon: FontAwesomeIcons.arrowTrendDown,
            texti: 'Summary',
            bonyeza: () {},
          ),
          ...
          wigi.stripTile(
              ...
              texti: 'Category breakdown',
              bonyeza: () {}),
          SizedBox(height: height * 0.03),
          wigi.stripTile(
              ikon: FontAwesomeIcons.chartLine, texti: 'Trends', bonyeza: () {}),
          SizedBox(height: height * 0.03),
          wigi.stripTile(
              ikon: FontAwesomeIcons.clock,
              texti: 'Timely Report',
              bonyeza: () {}),
          SizedBox(height: height * 0.03)
        ],
